...
class AdminTweaks {
    ...
    /**
     * Get stored slug for Snippets (varies by language)
     * 
     * Called by HooksPluginsExtras.php
     *
     * @return string
     */
    ...
    public function getSubMenus() {
        global $adtw_option;
        $all = get_option("$adtw_option-support", []);
        $ritorna = [];
        $empty = 0;
        if (!empty($all['current_submenus'])) :
	 ...
	 * https://wordpress.stackexchange.com/q/53675/12615
	 * 
	 * @param array $role
	 * @return boolean
	 */
