...
class HooksMedia {
	 ...
	 * 
	 * @author https://kucrut.org/insert-image-with-custom-size-into-post/
	 * 
	 */
	...
	public function camera_info_display( $column_name, $post_id ) {
		...
		if( wp_attachment_is( 'image', $post_id ) ) {
			...
			$exif = isset($meta['image_meta']) ? $meta['image_meta'] : false;
            if ($exif) {
    ...
    /**
     * Remove Redux allowance of this uploads
     *
     * @param array $mimes
     * @return array
     */
	 ...
	 *
	 * @author Heiko Rabe https://code-styling.de
	 * @link   https://www.code-styling.de/?p=574
	 * @param  string $str
	 * @return string
	 */
